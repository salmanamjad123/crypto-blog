    ...
    try {
      ...
      if (duplicates.length > 0) {
        ...
        const confirmed = window.confirm(
          `⚠️ A news article with the title "${title}" already exists.\n\n` +
          `Your URL will be: /news/${finalSlug}\n\n` +
      ...
      await addDoc(collection(db, 'posts'), newsPost);
  ...
  return (
    <div className="flex gap-6 h-[calc(100vh-8rem)] overflow-hidden">
      ...
      <div className="w-1/2 overflow-y-auto pr-4">
        <h1 className="text-2xl font-bold mb-4">Create a New News Article</h1>
      <div className="mb-4">
      ...
      >
        {saving ? '💾 Saving & Uploading Images...' : 'Save News'}
      </button>
      </div>
      ...
      <div className="w-1/2 overflow-y-auto border-l-2 border-gray-300 pl-6">
        <div className="sticky top-0 bg-gray-900 z-10 pb-4 mb-4 border-b border-gray-700">
          ...
          <p className="text-sm text-gray-400">See how your news will appear to readers</p>
        </div>
