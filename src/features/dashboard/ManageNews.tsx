            ...
            {filteredPosts.map(post => (
              <tr key={post.id} className="border-b border-gray-700">
                ...
                <td className="py-2 px-4 whitespace-nowrap">
                  <Link href={`/news/${post.slug || post.id}`} className="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded mr-2">
                    View
                  </Link>
                  <Link href={`/dashboard/edit-news/${post.id}`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded mr-2">
                    Edit
                  </Link>
                  <button 
